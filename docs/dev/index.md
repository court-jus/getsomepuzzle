...
- [`rectangular_groups.md`](constraints/rectangular_groups.md) — `RE`: the marked group
  must be a solid non-square rectangle.
- [`motif.md`](constraints/motif.md) — `FM`: a 2D colour pattern that must never
