...
// width and height. Consumers: `bin/vectorize_puzzles.dart` (CSV columns),
// `bin/detect_regular_solutions.dart` (diagnostic report), the generator's
// inline vector emission (`lib/getsomepuzzle/vector.dart`), and
// `test/spectral_features_test.dart`. `bin/_solution_geometry.dart` re-exports
// this file so the historical bin/ and test imports keep working.
