...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get visitOnlinePlayerGuide => 'Visitar la guía del jugador en línea';
  ...
  @override
  String get labelDomainTwoColors => 'Solo 2 colores';

  @override
  String get labelDomainThreeColors => 'Solo 3 colores';
  ...
  @override
  String get settingNextPuzzleDelay => 'Retraso al siguiente puzzle';

  @override
  String get settingNextPuzzleDelayS1 => '1 segundo';

  @override
  String get settingNextPuzzleDelayS3 => '3 segundos';

  @override
  String get settingNextPuzzleDelayS10 => '10 segundos';
  ...
  String createSolverTimedOut(String deduced, String total) {
    return 'Dejé de pensar después de 1 minuto y pude deducir $deduced celda(s) de $total';
  }

  @override
  String get createSolverWebExplanation =>
      'En la web, el cálculo bloquea la interfaz mientras se ejecuta. Pulsa «Lanzar» para empezar la verificación.';

  @override
  String get createSolverWebLaunch => 'Lanzar';
  ...
  @override
  String get tooltipPuzzleHelp => 'Ayuda del puzzle';

  @override
  String get puzzleHelpTitle => 'Ayuda del puzzle';
  ...
  String puzzleHelpIntro(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Este puzzle utiliza $count restricciones, aquí tienes un rápido recordatorio.',
      one:
          'Este puzzle utiliza 1 restricción, aquí tienes un rápido recordatorio.',
    );
    return '$_temp0';
  }
  ...
  String get thirdColorSuggestionBody =>
      'Has resuelto un buen número de puzles en blanco y negro. ¿Quieres probar el modo 3 colores? Un nuevo color — el púrpura — se une al negro y al blanco, y las reglas se aplican a cada color de forma independiente. Elige abajo cuántos puzles con púrpura quieres.';

  @override
  String get thirdColorSuggestionMixLabel => '¿Cuántos puzles de 3 colores?';
  ...
  String get thirdColorSuggestionFiltersReminder =>
      'Puedes cambiar esta mezcla en cualquier momento desde los filtros avanzados de la biblioteca.';
  ...
  String get endOfPlaylistSuggestionUp =>
      '¡Buen trabajo! ¿Quieres probar la siguiente colección?';

  @override
  String get endOfPlaylistSuggestionDown =>
      '¿Te lo estás pasando bien? ¿Quieres probar esta otra colección?';
